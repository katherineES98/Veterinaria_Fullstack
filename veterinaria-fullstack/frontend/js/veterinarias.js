...
try {
    ...
    const veterinariaDelServer = await respuesta.json();
    if (Array.isArray(veterinariaDelServer)) {
    ...
    veterinarias = veterinariaDelServer;
}
...
//*concatenar lo que ya hay en la variable mas o que le pondremos 
let urlEnvio= url;
let method="POST";
if (accion=='Editar') {
